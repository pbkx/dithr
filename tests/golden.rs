...
fn golden_random_seed_1_gray_ramp_8x8() {
    ...
    random_binary_in_place(&mut buffer, QuantizeMode::gray_bits(1), 1, 64)
...
fn golden_custom_ordered_2x2_gray_ramp_8x8() {
    ...
    custom_ordered_in_place(&mut buffer, QuantizeMode::gray_bits(1), &map, 2, 2, 64)
...
fn golden_ostromoukhov_gray_challenge_64x64() {
    ...
    ostromoukhov_in_place(&mut buffer, QuantizeMode::gray_bits(2))
...
fn golden_variable_diffusion_distinguishes_ostromoukhov_and_zhou_fang() {
    ...
    ostromoukhov_in_place(&mut ostromoukhov_buffer, QuantizeMode::gray_bits(2))
        .expect("ostromoukhov should succeed");
    zhou_fang_in_place(&mut zhou_fang_buffer, QuantizeMode::gray_bits(2))
