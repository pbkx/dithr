...
fn bench_ordered(c: &mut Criterion) {
    ...
    bench_gray_case(
        &mut group,
        "space_filling_curve_ordered_gray1_1024",
        &fixture,
        width,
        height,
        |buffer| space_filling_curve_ordered_dither_in_place(buffer, mode_gray_1()),
    );
    bench_gray_case(
        &mut group,
        "ranked_dither_gray1_1024",
        &fixture,
        width,
        height,
    ...
    bench_gray_case(
        &mut group,
        "polyomino_ordered_gray1_1024",
        &fixture,
        width,
        height,
        |buffer| polyomino_ordered_dither_in_place(buffer, mode_gray_1()),
    );
    bench_gray_case(
        &mut group,
        "stochastic_clustered_dot_gray1_1024",
        &fixture,
        width,
        height,
    ...
    bench_gray_case(
        &mut group,
        "blue_noise_multitone_dither_gray4_1024",
        &fixture,
        width,
        height,
        |buffer| blue_noise_multitone_dither_in_place(buffer, QuantizeMode::GrayLevels(4)),
    );
    bench_gray_case(
        &mut group,
