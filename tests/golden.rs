...
fn golden_bayer_4x4_gray_ramp_16x16() {
    ...
    .expect("bayer 4x4 should succeed");
...
#[test]
fn golden_void_and_cluster_gray_ramp_16x16() {
    let mut data = gray_ramp_16x16();
    let mut buffer = dithr::gray_u8(&mut data, 16, 16, 16).expect("valid buffer should construct");
...
#[test]
fn golden_space_filling_curve_ordered_gray_ramp_16x16() {
    let mut data = gray_ramp_16x16();
    let mut buffer = dithr::gray_u8(&mut data, 16, 16, 16).expect("valid buffer should construct");
...
#[test]
fn golden_image_based_dither_screen_gray_ramp_16x16() {
    let mut data = gray_ramp_16x16();
    let mut buffer = dithr::gray_u8(&mut data, 16, 16, 16).expect("valid buffer should construct");
    ...
    .expect("image-based dither screen should succeed");

    assert_eq!(fnv1a64(&data), 8_290_212_258_220_959_286_u64);
}

#[test]
fn golden_polyomino_ordered_gray_ramp_16x16() {
    let mut data = gray_ramp_16x16();
    let mut buffer = dithr::gray_u8(&mut data, 16, 16, 16).expect("valid buffer should construct");
    ...
    assert_eq!(fnv1a64(&data), 10_635_499_967_758_104_005_u64);
}

#[test]
fn golden_stochastic_clustered_dot_gray_ramp_16x16() {
    let mut data = gray_ramp_16x16();
    let mut buffer = dithr::gray_u8(&mut data, 16, 16, 16).expect("valid buffer should construct");
    ...
    assert_eq!(fnv1a64(&data), 1_940_931_942_480_500_182_u64);
}

#[test]
fn golden_am_fm_hybrid_halftoning_gray_ramp_16x16() {
    let mut data = gray_ramp_16x16();
    let mut buffer = dithr::gray_u8(&mut data, 16, 16, 16).expect("valid buffer should construct");
    ...
    assert_eq!(fnv1a64(&data), 6_423_847_279_977_571_159_u64);
}

#[test]
fn golden_clustered_am_fm_halftoning_gray_ramp_16x16() {
    let mut data = gray_ramp_16x16();
    let mut buffer = dithr::gray_u8(&mut data, 16, 16, 16).expect("valid buffer should construct");
...
#[test]
fn golden_hvs_optimized_error_diffusion_gray_ramp_16x16() {
    let mut data = gray_ramp_16x16();
    let mut buffer = dithr::gray_u8(&mut data, 16, 16, 16).expect("valid buffer should construct");
...
fn golden_variable_diffusion_distinguishes_ostromoukhov_and_zhou_fang() {
    ...
    ostromoukhov_in_place(
        &mut ostromoukhov_buffer,
        QuantizeMode::gray_bits(2).expect("valid bit depth"),
    )
    .expect("ostromoukhov should succeed");
    zhou_fang_in_place(
        &mut zhou_fang_buffer,
        QuantizeMode::gray_bits(2).expect("valid bit depth"),
    )
    .expect("zhou-fang should succeed");
...
#[test]
fn golden_multiscale_error_diffusion_gray_challenge_64x64() {
    let mut data = variable_gray_challenge_64x64();
    let mut buffer = dithr::gray_u8(&mut data, 64, 64, 64).expect("valid buffer should construct");
    ...
    .expect("multiscale error diffusion should succeed");

    assert_eq!(fnv1a64(&data), 9_756_998_446_205_497_565_u64);
}

#[test]
fn golden_feature_preserving_msed_gray_challenge_64x64() {
    let mut data = variable_gray_challenge_64x64();
    let mut buffer = dithr::gray_u8(&mut data, 64, 64, 64).expect("valid buffer should construct");
...
#[test]
fn golden_linear_pixel_shuffling_gray_challenge_64x64() {
    let mut data = variable_gray_challenge_64x64();
    let mut buffer = dithr::gray_u8(&mut data, 64, 64, 64).expect("valid buffer should construct");
    ...
    assert_eq!(fnv1a64(&data), 482_996_107_186_433_349_u64);
}

#[test]
fn golden_tone_dependent_error_diffusion_gray_challenge_64x64() {
    let mut data = variable_gray_challenge_64x64();
    let mut buffer = dithr::gray_u8(&mut data, 64, 64, 64).expect("valid buffer should construct");
...
#[test]
fn golden_vector_error_diffusion_rgb_gradient_8x8() {
    let mut data = rgb_gradient_8x8();
    let mut buffer = dithr::rgb_u8(&mut data, 8, 8, 24).expect("valid buffer should construct");
...
#[test]
fn golden_semivector_error_diffusion_rgb_gradient_8x8() {
    let mut data = rgb_gradient_8x8();
    let mut buffer = dithr::rgb_u8(&mut data, 8, 8, 24).expect("valid buffer should construct");
...
#[test]
fn golden_direct_pattern_control_rgb_gradient_8x8() {
    let mut data = rgb_gradient_8x8();
    let mut buffer = dithr::rgb_u8(&mut data, 8, 8, 24).expect("valid buffer should construct");
...
fn golden_bayer_8x8_rgb_gradient_8x8_f32_binary_invariant() {
    ...
    let mut buffer = dithr::rgb_32f(&mut data, 8, 8, 24).expect("valid buffer should construct");
