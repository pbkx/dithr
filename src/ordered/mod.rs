...
#[cfg(feature = "rayon")]
pub fn bayer_2x2_in_place_par(buffer: &mut Buffer<'_>, mode: QuantizeMode<'_>) -> DithrResult<()> {
...
#[cfg(feature = "rayon")]
pub fn bayer_4x4_in_place_par(buffer: &mut Buffer<'_>, mode: QuantizeMode<'_>) -> DithrResult<()> {
...
#[cfg(feature = "rayon")]
pub fn bayer_8x8_in_place_par(buffer: &mut Buffer<'_>, mode: QuantizeMode<'_>) -> DithrResult<()> {
...
#[cfg(feature = "rayon")]
pub fn bayer_16x16_in_place_par(
    buffer: &mut Buffer<'_>,
    mode: QuantizeMode<'_>,
) -> DithrResult<()> {
...
#[cfg(feature = "rayon")]
pub fn cluster_dot_4x4_in_place_par(
    buffer: &mut Buffer<'_>,
    mode: QuantizeMode<'_>,
) -> DithrResult<()> {
...
#[cfg(feature = "rayon")]
pub fn cluster_dot_8x8_in_place_par(
    buffer: &mut Buffer<'_>,
    mode: QuantizeMode<'_>,
) -> DithrResult<()> {
...
fn validate_custom_map(map: &[u8], map_w: usize, map_h: usize) -> Result<(), OrderedError> {
    if map.is_empty() {
